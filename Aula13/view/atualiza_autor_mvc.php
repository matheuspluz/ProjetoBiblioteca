...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="p-3 mb-2 bg-success text-white"><h1>Cadastro de Autores<h1></div><br><br>
  <form action="../controller/acao_atualiza_autor.php"  method="post">
  <div class="form-group">
    <label for="exampleInputText">Id Autor</label>
    <input type="text" class="form-control" id="IdAutor" name="IdAutor" aria-describedby="emailHelp" placeholder="Informe o ID do autor">
  </div>
  <div class="form-group">
